...
export function AppFooter({ t }: Readonly<{ t: Translator }>) {
  return (
    <footer
      className="flex w-full items-center justify-between gap-4 border-t border-[rgb(111_151_201_/_13%)] bg-[rgb(9_15_25_/_42%)] px-[clamp(1rem,3vw,2rem)] py-[0.85rem] text-xs text-app-text-muted max-[760px]:items-start max-[760px]:flex-col max-[760px]:gap-2 max-[760px]:px-4 max-[760px]:py-3"
